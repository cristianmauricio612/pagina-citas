...
$stmt = $pdo->query("SELECT * FROM anuncios WHERE hidden = 0 AND expires_at >= NOW() ORDER BY activated_at DESC");
    ...
    <div class="content">
        <div class="cinta">
            <div class="cinta-texto">
                Las mejores escorts de la ciudad 💋 Atención al cliente 24/7 💋 Realiza tus pagos de manera virtual 💋
                Las mejores putas de la zona
            </div>
        </div>
        ...
        <div class="anuncios-grid">
            ...
            <?php foreach ($anuncios as $anuncio): ?>
                <div class="anuncio-card" onclick="showPopup(this)"
                    ...
                    <div class="anuncio-imagen">
                        <img src="<?= htmlspecialchars($anuncio['principal_picture'], ENT_QUOTES, 'UTF-8'); ?>"
                        ...
                        <div class="anuncio-overlay">
                            ...
                            <a href="#" class="anuncio-badge timeclock" title="Tiempo de publicación">Hace <span
                                    class="timecount"><?= tiempoTranscurrido($anuncio['created_at']); ?></span></a>
                        </div>
                        <div class="anuncio-detalle">
                            <h5 class="anuncio-titulo"><?= htmlspecialchars($anuncio['titulo'], ENT_QUOTES, 'UTF-8'); ?>
                            </h5>
            ...
            <div class="row row-container">
                    ...
                    <div class="card shadow-lg border-0 rounded-4 p-4">
                        ...
                        <h4 class="m-auto mb-2" style="width: 95%; text-align: left;">
                            <i class="fa-solid fa-map-location-dot" style="color: #a90b35;"></i> Ubicación: <span
                                id="ciudadlocation" style="color: #a90b35;"></span>
                        </h4>
                ...
                <div class="col-2">
                    <div class="card popup-perfil shadow-lg">
                        <img src="/assets/img/fotos/perfil1.webp" class="card-img-top mx-auto popup-picture"
                            id="profilepicture" alt="Profile Picture" style="width: 150px;">
                        <div class="card-body">
