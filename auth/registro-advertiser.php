...
<head>
    ...
    <title>Registrarse ( Anunciante ) 💋 • FantaSexAnuncios.com 💋</title>
...
<body class="body-advertiser">
    <div class="form-container">
        ...
        <h2>Registrarse</h2>
        <span class="badgetype">Anunciante</span>
        <form id="register-form" method="POST">
            <input type="hidden" id="register-type" name="type" value="advertiser">
            <div class="mb-3">
